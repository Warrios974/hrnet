    ...
    return (
        ...
        >
            <div className="bg-gray-50 px-4 py-2 sm:flex sm:flex-row-reverse sm:px-6">
                <button onClick={() => setIsOpen(false)} className='inline-flex bg-transparent bg-slate-100 border rounded-md border-gray-300 px-2 py-1 text-sm font-semibold text-black shadow-sm sm:ml-3 sm:w-auto'>
                    esc
                </button>
            </div>
            <div className="flex flex-col items-center bg-white px-4 sm:p-6 sm:pb-4">
                <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-green-100 my-4 sm:mx-0 sm:h-10 sm:w-10">
                    <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5"></path></svg>
                </div>
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                <Link href={'/employees'} type="button" className="inline-flex w-full justify-center rounded-md bg-lime-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto">Go to employees</Link>
            </div>
        </ReactModal>            
    )
}